        ...
        <section className="mb-4 overflow-hidden rounded-2xl border border-slate-200 bg-indigo-50/50 p-3 shadow-sm sm:mb-8 sm:p-5">
          {!showUpload ? (
            <div className="flex items-center justify-between gap-3">
              ...
              <button onClick={() => setShowUpload(true)} className="inline-flex shrink-0 items-center gap-1.5 rounded-xl bg-indigo-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-indigo-700 sm:gap-2 sm:px-4 sm:py-2.5 sm:text-sm">
