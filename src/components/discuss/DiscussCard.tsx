...
export default function DiscussCard({ post, onApprove, onReject, onDelete }: DiscussCardProps) {
  ...
  return (
    <article className="ui-card ui-card-hover relative overflow-hidden">
      ...
      <div className="md:hidden">
        ...
        <div className="flex flex-col gap-2 p-3">
          <div className="flex flex-wrap items-center gap-1">
            ...
            {post.clubName && (
              <span className="ui-chip px-2 py-0.5 text-[8px] uppercase inline-flex items-center gap-1">
                {post.clubName}
      ...
      {/* ─── Desktop layout: horizontal image + content ─── */}
      <div className="hidden md:grid md:min-h-[12rem] md:grid-cols-[16rem_minmax(0,1fr)]">
        <a
          href={coverUrl}
          target="_blank"
          rel="noreferrer"
        ...
        <div className="flex flex-col justify-center gap-4 p-5 sm:p-7">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="ui-chip text-[11px] uppercase inline-flex items-center gap-1">
              {post.clubName}
