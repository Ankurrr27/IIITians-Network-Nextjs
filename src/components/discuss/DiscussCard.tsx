        ...
        <div className="flex flex-col gap-1.5 p-3">
          ...
          {post.actionLink && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-0.5 inline-flex w-fit items-center gap-1 rounded-full bg-slate-900 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wide text-white transition hover:bg-indigo-700"
            >
          ...
          <div className="flex items-center gap-2 pt-0.5">
            {post.actionLink && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-fit items-center gap-1 rounded-full bg-slate-900 px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wide text-white transition hover:bg-indigo-700"
              >
