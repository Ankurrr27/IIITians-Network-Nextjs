        ...
        <div className="mt-auto flex items-center justify-between pt-2.5">
          {event.link ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1 rounded-xl bg-indigo-600 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wide text-white transition hover:bg-indigo-700"
            >
