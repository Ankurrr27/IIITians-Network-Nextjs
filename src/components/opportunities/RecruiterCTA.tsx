    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-xl">
          ...
          >
            Instead of contacting 25+ campuses individually, reach the entire IIIT ecosystem
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          <button
            onClick={onPostClick}
            className="inline-flex items-center justify-center gap-2 rounded-full bg-indigo-600 px-6 py-3 text-sm font-bold text-white shadow-md shadow-indigo-500/20 transition hover:bg-indigo-700 active:scale-95"
          >
          ...
          <a
            ...
            className={`inline-flex items-center justify-center gap-2 rounded-full border px-6 py-3 text-sm font-bold transition active:scale-95 ${
              isDarkMode
